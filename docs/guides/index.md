...
- **agent-templates.md** — the `.adf` files new agents are made from: the three Studio ships, what an instance carries, editing templates and taking one from someone else
