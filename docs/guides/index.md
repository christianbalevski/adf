...
- **browser.md** — the Computer tab: visible desktop (IceWM), managed Chromium, interactive takeover, MCP automation, xdotool/scrot computer use, and portable encrypted profiles
