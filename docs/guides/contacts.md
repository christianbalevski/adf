...
2. **Agent cards.** The portable identity object — signed, self-describing, fetchable over HTTP at `GET /{handle}/card`, and included in the return of `agent_discover`. Cards travel in message payloads when agents introduce themselves or introduce others.
...
// contacts.json
[
  { "handle": "monitor", "did": "did:key:z6Mk...", "address": "http://127.0.0.1:7295/monitor/inbox" }
]
```
