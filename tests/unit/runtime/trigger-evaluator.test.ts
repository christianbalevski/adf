  ...
  describe('DB lookup — onInbox full InboxMessage', () => {
    it('uses full InboxMessage from workspace when messageId is provided', () => {
      ...
      const fullRow = {
        ...
        return_path: 'telegram:123456789',
        source: 'telegram',
        source_context: { chat_id: '123456789', message_id: '1032' },
      ...
      const events = collectEvents(evaluator)
      evaluator.onInbox('telegram:123456789', 'Yes', { source: 'telegram', messageId: 'inbox-123' })
      ...
      expect(msg.message.source_context).toEqual({ chat_id: '123456789', message_id: '1032' })
