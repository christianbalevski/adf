...
- The filesystem is flat (no real directories): \`pwd\` returns \`/\`, \`grep pattern .\` searches all files. grep/sed remain built-ins: ERE regex only, \`2>/dev/null\` silently ignored.
