...
import type { McpServerLogEntry } from '../../../shared/types/adf-v02.types'
...
export function McpServerLogs({ logs, onClose, serverName }: McpServerLogsProps) {
        ...
        {logs.length === 0 ? (
          ...
          logs.map((entry, i) => {
            ...
            const color =
              ...
              entry.stream === 'system' ? 'text-blue-400' :
              'text-neutral-300'
            return (
