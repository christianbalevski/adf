...
const InputSchema = z.object({
  ...
  address: z
    ...
    .url()
    .optional()
    .describe('Delivery URL for mesh recipients (e.g., "http://127.0.0.1:7295/agent-handle/inbox"). Required unless parent_id is provided or sending to an adapter recipient.'),
  content: z
    .string()
    .min(1)
